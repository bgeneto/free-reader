        ...
        <div className="mt-8 flex flex-col items-center gap-3">
          <div className="inline-flex items-center bg-accent rounded-full p-1">
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-full transition-all ${billingPeriod === "annual"
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-full transition-all ${billingPeriod === "monthly"
                ? "bg-foreground text-background shadow-sm"
                : "text-muted-foreground hover:text-foreground"
                }`}
            >
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="rounded-xl border border-border overflow-hidden">
                ...
                >
                  ...
                  <ChevronDown
                    className={`size-4 text-muted-foreground transition-transform ${openFaq === i ? "rotate-180" : ""
                      }`}
                  />
                </button>
                {openFaq === i && (
